...
class CarDetails extends React.Component {
  ...
  componentDidMount() {
    fetch("/resources/cars/" + window.location.pathname.split('/')[2])
      .then(
        (res) => {
          if (res.ok) {
            return res;
...
if (document.getElementById('car_details_container')) {
    ReactDOM.render(<CarDetails />, document.getElementById('car_details_container'));
}
